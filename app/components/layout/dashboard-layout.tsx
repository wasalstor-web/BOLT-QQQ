...
export function DashboardLayout({ children, user }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-950" dir="rtl">
      {/* Sidebar */}
      <Sidebar user={user} onLogout={handleLogout} onNewProject={handleNewProject} onSearch={open} />
      ...
      {/* Command Menu */}
      <CommandMenu isOpen={isOpen} onClose={close} onNavigate={handleNavigate} onAction={handleAction} />
    </div>
  );
}
